...
public class AppViewManager {
    ...
    public static final AppView MAINMENU_VIEW = view("MainMenu", MainMenuPresenter.class, MaterialDesignIcon.HOME, SHOW_IN_DRAWER, HOME_VIEW, SKIP_VIEW_STACK);
    ...
    public static void registerViewsAndDrawer(MobileApplication app) {
        ...
        NavigationDrawer.Header header = new NavigationDrawer.Header("Gluon Mobile",
                "Multi View Project",
                new Avatar(21, new Image(MossysFantasyFrisbeeG.class.getResourceAsStream("/icon.png"))));
